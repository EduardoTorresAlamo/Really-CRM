...
// Passwordless magic-link login via Supabase OTP. signInWithOtp emails a link to /auth/callback,
// which exchanges the code for a session. emailRedirectTo must match an allowed redirect URL in
// the Supabase Auth dashboard or the link is rejected.
